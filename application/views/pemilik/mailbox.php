          ...
          <div class="card shadow mb-4">
			...
			<div style="height:350px; overflow:auto; ">
				<?php
					...
					<hr>
					<form method="post">
				<textarea placeholder="Masukan pesan anda..." name="msg" class="form-control"></textarea>
				<br>
			...
			<?php 
				if($_POST[smsg]!=''){
					...
					mysqli_query($conn,"insert into mailbox set pesan='$pesan', dari='$nama->id_pemilik', untuk='$to'");
					?>
